...
class CheckedInParticipantTest {
    ...
    void get_correct_check_in_date() {
        ...
        CheckedInParticipant michel = CheckedInParticipantHelper.create(checkInFriday, checkOutSunday,
    ...
    void get_correct_check_in_date_thursday() {
        ...
        CheckedInParticipant michel = CheckedInParticipantHelper.create(checkInThursday, checkOutSunday,
                ChoiceAccommodation.TWIN);
