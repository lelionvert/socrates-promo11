...
public class EvenmentTest
{
    ...
    public void number_participants_equals_5() throws ParseException {
        ...
        listParticipants.add(formatDate.parse("2019-10-17 23:00"));
    ...
    @Test
    public void check_cold_meal_for_friday_02h_is_false() throws ParseException {
        // Given
        SimpleDateFormat formatDate = new SimpleDateFormat ("yyyy-MM-dd HH:mm");
        List<Date> listParticipants = new ArrayList<Date>();
        listParticipants.add(formatDate.parse("2019-10-17 20:00"));
        ...
        // When / Then
        Assertions.assertThat(theEvent.checkColdMeal(listParticipants.get(4))).isFalse();
    }
